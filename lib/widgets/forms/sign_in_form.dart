...
import 'package:grocery_app/screens/authentication/sign_up_screen.dart';
...
class _EPSignInFormState extends State<EPSignInForm> {
  ...
  Future<String> _checkUserAlreadyRegistered(String userEmailID) async {
    ...
    var result = await FirebaseFirestore.instance
        ...
        .where("emailID", isEqualTo: userEmailID)
        .get();
                      ...
                      onPressed: () async {
                        ...
                        if (_signInFormKey.currentState!.validate()) {
                          ...
                          String userDisplayName =
                              await _checkUserAlreadyRegistered(
                                  userEnteredEmailID);
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      ...
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: Colors
                            .green, // Use the specific green shade if needed, e.g., Colors.green[700]
                        letterSpacing: 0.5,
                      ),
                    ),
                  ],
