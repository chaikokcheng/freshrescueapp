...
final CollectionReference _mainCollection =
    _firestore.collection('students_data');
...
class Database {
  ...
  static Future<void> addItem(
      ...
      required String majorDomain}) async {
    ...
    DocumentReference documentReferencer0 =
        _firestore.collection('students_data').doc(userUid);

    DocumentReference documentReferencer1 =
        _firestore.collection(yearOfStudy).doc(userUid);

    DocumentReference documentReferencer2 =
        _firestore.collection(majorDomain).doc(userUid);
  ...
  static Stream<QuerySnapshot> readTechies(String nameOfDomain) {
    var techiesCollection = FirebaseFirestore.instance
        .collection(nameOfDomain)
        .orderBy("yearOfStudy");
