...
import 'package:grocery_app/screens/authentication/student_details_screen.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(),
              Image.asset('assets/icons/freshrescue.png', height: 150),
              ...
              Visibility(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      primary:
                          AppColors.primaryColor // This is the background color
                      ),
                  child: Row(
                    mainAxisSize: MainAxisSize
                        .min, // Use Min to keep the row as big as its children
                    children: [
                      Icon(Icons.refresh,
                ...
                onToggle: (index){
                  print('Switched to $index');
                      ...
                      SwipeableButtonView(
                        ...
                        activeColor: Color.fromARGB(255, 100, 164, 132),
                        onWaitingProcess: () {
